              ...
              <div className={`flex flex-col justify-between py-2 rounded border border-solid max-md:max-w-full ${cardValidation?'border-pd-red':'border-pd-black'}`}>
                {
                  cards.length < 1 ? (
                    ...
                    return (
                      <CardItem key={index} card={card} index={index} cardType={cardType} setSelectedCard={setSelectedCard} removeCard={removeCard} cards={cards} cardValidation={cardValidation} pdcard={pdcard} />
